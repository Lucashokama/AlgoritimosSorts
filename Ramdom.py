...
if __name__ == "__main__":
    print("RANDOM")
    print("   N      Heapsort     Quicksort   Mergesort   Selectionsort   Coutingsort   Insertionsort")
    for x in range(1000, 21000, 1000):
        lista = generate_random_list(x,1,20000)
        tempo = measure_time(lista,heap_sort)  
        tempo2 = measure_time(lista, quick_sort)
        tempo3 = measure_time(lista, merge_sort)
        tempo4 = measure_time(lista, selection_sort)
        tempo5 = measure_time(lista, counting_sort)
        tempo6 = measure_time(lista, insertion_sort)     
        print(f"  {x  }    {tempo:.8f}   {tempo2:.8f}   {tempo3:.8f}   {tempo4:.8f}   {tempo5:.8f}    {tempo6:.8f}")
